...
elseif lower(types(1)) == "neumann"
    T(:,1) = T(:,3) - repmat(2 * Delta_y * values(1),r,1);
end
...
elseif lower(types(2)) == "neumann"
    T(:,end) = T(:,end-2) + repmat(2 * Delta_y * values(2),r,1);
end
...
elseif lower(types(3)) == "neumann"
    T(1,:) = T(3,:) - repmat(2 * Delta_x * values(3),1,c);
end
...
elseif lower(types(4)) == "neumann"
    T(end,:) = T(end-2,:) - repmat(2 * Delta_x * values(4),1,c);
end
